...
import com.example.laundry.RequestHandler;
...
public class order_details extends AppCompatActivity {
    private TextView t_id,t_name,t_contact,t_email,t_address,t_date,t_type,t_stype,t_noof,t_prunit,t_amo;
    private long l_id,l_contact,l_noof,l_cost,l_ammount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t_id=findViewById(R.id.tvid1);
        t_name=findViewById(R.id.tvname1);
        t_contact=findViewById(R.id.tvcontact1);
        t_email=findViewById(R.id.tvemail1);
        t_address=findViewById(R.id.tvaddress1);
        t_date=findViewById(R.id.tvdate1);
        t_type=findViewById(R.id.tvtype1);
        t_stype=findViewById(R.id.tvstype1);
        t_noof=findViewById(R.id.noc1);
        t_prunit=findViewById(R.id.tvcost1);
        t_amo=findViewById(R.id.tvamount1);
