        ...
        bt_cp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(str_newp.isEmpty() || str_confp.isEmpty() || str_oldp.isEmpty()){
                    Toast.makeText(change_password.this, "Please fill all the fields", Toast.LENGTH_SHORT).show();
                }
                                ...
                                public void onResponse(String response) {
                                    ...
                                    try {
                                        ...
                                        if(!obj.getBoolean("error")) {
                                            Toast.makeText(change_password.this,obj.getString("message"), Toast.LENGTH_SHORT).show();
                                        } else {
                                            Toast.makeText(change_password.this,obj.getString("message"), Toast.LENGTH_SHORT).show();
                                        }
                    ...
                    RequestHandler.getInstance(change_password.this).addToRequestQueue(stringRequest);
                }
                else {
