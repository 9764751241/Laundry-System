...
public class edit_order extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    String Id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(str_no.isEmpty()){
                    Toast.makeText(edit_order.this, "Please fill all the fields", Toast.LENGTH_SHORT).show();
                }
                else {
                                ...
                                public void onResponse(String response) {
                                    ...
                                    try {
                                        ...
                                        if(!obj.getBoolean("error")) {
                                            Toast.makeText(edit_order.this, obj.getString("message"), Toast.LENGTH_SHORT).show();
                                            startActivity(new Intent(edit_order.this,my_orders.class));
                    ...
                    RequestHandler.getInstance(edit_order.this).addToRequestQueue(stringRequest);
                }
            }
        });
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for(int i=0; i < ja.length(); i++)
                    {
                        ...
                        laun_adapter1=new ArrayAdapter<>(edit_order.this,android.R.layout.simple_spinner_dropdown_item,laun_array1);
                ...
                public void onResponse(JSONObject response) {
                    try {
                        ...
                        for(int i=0; i < jsonArray.length(); i++)
                        {
                            ...
                            laun_s_adapter1=new ArrayAdapter<>(edit_order.this,android.R.layout.simple_spinner_dropdown_item,laun_s_array1);
